...
class OpenAIClone(openai.OpenAI):
    def __init__(self):
        super().__init__(api_key=os.environ['MOONSHOT_API_KEY'],
...
class BaseOpenAI(BaseLLM):
    ...
    def lc_secrets(self) -> Dict[str, str]:
        return {"openai_api_key": "MOONSHOT_API_KEY"}
    ...
    model_name: str = Field(default="moonshot-v1-32k", alias="model")
    """Model name to use."""
    ...
    """Automatically inferred from env var `MOONSHOT_API_KEY` if not provided."""
    openai_api_base: Optional[str] = Field(default="https://api.moonshot.cn/v1", alias="base_url")
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        openai_api_key = get_from_dict_or_env(
            values, "openai_api_key", "MOONSHOT_API_KEY"
        )
    ...
    def modelname_to_contextsize(modelname: str) -> int:
        ...
        """
        model_token_mapping = {
            # TODO List moonshot models here.
            "gpt-4": 8192,
            "gpt-4-0314": 8192,
            "gpt-4-0613": 8192,
            "gpt-4-32k": 32768,
...
class OpenAI(BaseOpenAI):
    ...
    To use, you should have the environment variable ``MOONSHOT_API_KEY``
