...
from ..embeddings.base import OpenAIEmbeddings
...
class AzureOpenAIEmbeddings(OpenAIEmbeddings):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        # TODO: Remove MOONSHOT_API_KEY support to avoid possible conflict when using
        # other forms of azure credentials.
        openai_api_key = (
            values["openai_api_key"]
            or os.getenv("AZURE_MOONSHOT_API_KEY")
